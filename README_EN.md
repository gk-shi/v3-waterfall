...
|     resizeFlag     |                           boolean                            |           true           |    no    | Control whether to listen for the window `resize` event to trigger a redraw. Refer to the usage scenarios:[#40](https://github.com/gk-shi/v3-waterfall/issues/40) |
